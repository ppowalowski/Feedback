...
class WebspeaksFeedback_Fancyfeedback_Adminhtml_FancyfeedbackController extends Mage_Adminhtml_Controller_action
{
    ...
    public function sendMail($email, $name, $subject='', $message='') {
        $sender = Array(
            'email' => Mage::getStoreConfig('fancyfeedbackconfig/fancyfeedback_group/fancyfeedback_senderemail'),
            'name' => Mage::getStoreConfig('fancyfeedbackconfig/fancyfeedback_group/fancyfeedback_sendername')
        );
        ...
        $templateId = Mage::getStoreConfig('fancyfeedbackconfig/fancyfeedback_group/fancyfeedback_email_template_reply');
        $storeId = Mage::app()->getStore()->getId($templateId);
